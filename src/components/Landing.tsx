  ...
  return (
    <section className="landing p-14 bg-[#F2F0F1] pb-0 max-md:p-0">
      <div className="container mx-auto flex items-center justify-between max-lg:flex-col max-lg:justify-center">
        <div className="left-section grid gap-8 w-1/2 max-lg:w-full pb-8 max-md:px-4 max-md:py-8">
          <h1 className="title text-[54px] font-bold leading-[1] whitespace-nowrap max-md:text-[36px] max-md:text-center">FIND CLOTHES <br /> THAT MATCHES <br /> YOUR STYLE</h1>
          <p className="desc text-[15px] leading-[1.6] text-slate-500 font-light font-sans max-md:text-center">Browse through our diverse range of meticulously crafted garments, designed to bring out your individuality and cater to your sense of style.</p>
